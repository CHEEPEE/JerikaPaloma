...
public class FragementBookAndManuals extends Fragment{
   private ListView mListViewOptionItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mlistAdapter = new listAdapter(getActivity(),ItemList.convertToArrayList(ItemList.books_manuals_item_description),ItemList.convertToArrayList(ItemList.books_manuals_unit),ItemList.convertToArrayList(ItemList.books_manuals_selling_price),ItemList.bookIcons,ItemList.convertToArrayListBoolean(ItemList.avai_books));
